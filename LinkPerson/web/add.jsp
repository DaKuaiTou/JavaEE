...
<div class="container">
    ...
    <form action="linkPerson" method="post">
        ...
        <div class="form-group">
            ...
            <input type="text" name="qq" id="qq" class="form-control" placeholder="请输入QQ号码">
        </div>
        <div class="form-group">
        ...
        <div class="form-group" style="text-align: center">
            ...
            <input type="button" value="返回" class="btn btn-default" onclick="location.href='linkPerson?action=findAllPerson'">
        </div>
    </form>
</div>
</body>
